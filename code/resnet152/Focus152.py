...
csv_logger = CSVLogger('resnet152'+time.strftime("%Y%m%d_%H%M%S")+'.csv')
...
def train():
    ...
    if not data_augmentation:
        ...
        modelName = "model152" + time.strftime("%Y%m%d_%H%M%S") + ".json"
        ...
        modelWeight = "model152Weight" + time.strftime("%Y%m%d_%H%M%S") + ".h5"
