...
csv_logger = CSVLogger('resnet50'+time.strftime("%Y%m%d_%H%M%S")+'.csv')
...
def train():
    ...
    if not data_augmentation:
        ...
        modelName = "model50" + time.strftime("%Y%m%d_%H%M%S") + ".json"
        ...
        modelWeight = "model50Weight" + time.strftime("%Y%m%d_%H%M%S") + ".h5"
